...
Note: the docs are verbatim copies (plus a provenance header). Relative links between the nine contracts still resolve; relative links to patterns that did **not** move (e.g. `./canonical-ports.md`, `./governance.md`, `./trust-gradient-isolation.md`) point at the parachute-patterns archive.
