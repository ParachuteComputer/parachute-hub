...
if [ "${XFAIL_COUNT:-0}" -gt 0 ]; then
  warn "E2E PASSED with ${XFAIL_COUNT} XFAIL(s) — known, tracked live bug(s) surfaced (see the FINDING block(s) above, e.g. hub#610 wipe-recovery / vault#464 MCP-over-public JWKS hairpin)."
